...
// WaveDAC8_v2_0(Clock_SRC=1, DAC_Range=1, DacModeReplString=VDAC8, Sample_Clock_Freq=48000, Wave1_Amplitude=4, Wave1_Data=252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u, Wave1_DCOffset=2.04, Wave1_Length=100, Wave1_PhaseShift=0, Wave1_Type=1, Wave2_Amplitude=4, Wave2_Data=252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,252u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u,3u, Wave2_DCOffset=2.04, Wave2_Length=100, Wave2_PhaseShift=0, Wave2_Type=1, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=WaveDAC8_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=WaveDAC8, CY_INSTANCE_SHORT_NAME=WaveDAC8, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP1, INSTANCE_NAME=WaveDAC8, )
...
module ADC_DelSig_v3_20_3 (
	...
	cy_clock_v1_0
		#(.id("a6130b5d-ca9f-4a29-aef3-5625dd68fe46/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("a6130b5d-ca9f-4a29-aef3-5625dd68fe46/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__Wave_Output_net;
	wire [0:0] tmpFB_0__Wave_Output_net;
	wire [0:0] tmpIO_0__Wave_Output_net;
	wire [0:0] tmpINTERRUPT_0__Wave_Output_net;
	electrical [0:0] tmpSIOVREF__Wave_Output_net;

	cy_psoc3_pins_v1_10
		#(.id("a783b260-3f8f-4521-800a-d49c026b1397"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Wave_Output
		 (.oe(tmpOE__Wave_Output_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Wave_Output_net[0:0]}),
		  .analog({Net_193}),
		  .io({tmpIO_0__Wave_Output_net[0:0]}),
		  .siovref(tmpSIOVREF__Wave_Output_net),
		  .interrupt({tmpINTERRUPT_0__Wave_Output_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Wave_Output_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_4 UART (
        ...
        .reset(Net_269),
        .rx(1'b0),
        .tx_interrupt(Net_271),
        .rx_interrupt(Net_272),
        .tx_data(Net_273),
        .tx_clk(Net_274),
        .rx_data(Net_275),
        .rx_clk(Net_276));
	...
	cy_psoc3_pins_v1_10
		#(.id("db5e32a8-5f68-454b-b5cb-c96eafe36cd3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
