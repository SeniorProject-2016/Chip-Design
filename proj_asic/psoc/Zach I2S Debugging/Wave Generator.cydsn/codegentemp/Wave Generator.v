...
module top ;
    ...
    I2S_v2_70_2 I2S_1 (
        ...
        .tx_dma0(Net_395[0:0]),
        .tx_dma1(Net_396[0:0]),
        .rx_interrupt(Net_397),
        .tx_interrupt(Net_398),
        .clip(Net_399[0:0]));

	wire [0:0] tmpOE__SCK_1_net;
	wire [0:0] tmpFB_0__SCK_1_net;
	wire [0:0] tmpIO_0__SCK_1_net;
	wire [0:0] tmpINTERRUPT_0__SCK_1_net;
	electrical [0:0] tmpSIOVREF__SCK_1_net;

	cy_psoc3_pins_v1_10
		#(.id("bbb03083-c85a-4e05-86f1-e7e4e569b219"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SCK_1
		 (.oe(tmpOE__SCK_1_net),
		  .y({Net_391}),
		  .fb({tmpFB_0__SCK_1_net[0:0]}),
		  .io({tmpIO_0__SCK_1_net[0:0]}),
		  .siovref(tmpSIOVREF__SCK_1_net),
		  .interrupt({tmpINTERRUPT_0__SCK_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SCK_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__WS_1_net;
	wire [0:0] tmpFB_0__WS_1_net;
	wire [0:0] tmpIO_0__WS_1_net;
	wire [0:0] tmpINTERRUPT_0__WS_1_net;
	electrical [0:0] tmpSIOVREF__WS_1_net;

	cy_psoc3_pins_v1_10
		#(.id("27a2eabd-c3a4-4438-b671-52d95b936385"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		WS_1
		 (.oe(tmpOE__WS_1_net),
		  .y({Net_378}),
		  .fb({tmpFB_0__WS_1_net[0:0]}),
		  .io({tmpIO_0__WS_1_net[0:0]}),
		  .siovref(tmpSIOVREF__WS_1_net),
		  .interrupt({tmpINTERRUPT_0__WS_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__WS_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SDI_1_net;
	wire [0:0] tmpIO_0__SDI_1_net;
	wire [0:0] tmpINTERRUPT_0__SDI_1_net;
	electrical [0:0] tmpSIOVREF__SDI_1_net;

	cy_psoc3_pins_v1_10
		#(.id("467450a7-c834-44e6-9f16-a32d0409dbc1"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SDI_1
		 (.oe(tmpOE__SDI_1_net),
		  .y({1'b0}),
		  .fb({Net_376}),
		  .io({tmpIO_0__SDI_1_net[0:0]}),
		  .siovref(tmpSIOVREF__SDI_1_net),
		  .interrupt({tmpINTERRUPT_0__SDI_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SDI_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
