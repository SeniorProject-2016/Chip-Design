...
void DmaRxConfiguration(void)
{
    ...
    CyDmaTdSetConfiguration(RxDMA_TD_0[0], 960, RxDMA_TD_0[0], TD_INC_DST_ADR);
	CyDmaTdSetConfiguration(RxDMA_TD_1[0], 960, RxDMA_TD_1[0], TD_INC_DST_ADR);
...
void DmaTxConfiguration(void)
{
	...
	CyDmaTdSetConfiguration(TxDMA_0_TD[0], 960, TxDMA_0_TD[0], TD_INC_SRC_ADR);
    CyDmaTdSetConfiguration(TxDMA_1_TD[0], 960, TxDMA_1_TD[0], TD_INC_SRC_ADR);
