...
#endif
static const char *ng0 = "C:/Users/kevin/Documents/GitHub/Chip-Design/proj_asic/rtl/Project without i2c/filter_round_truncate.v";
static int ng1[] = {12, 0};
static int ng2[] = {3, 0};
...
LAB2:    xsi_set_current_line(47, ng0);
    ...
    t6 = (t0 + 2168U);
    t7 = *((char **)t6);
    xsi_vlog_mul_concat(t5, 3, 1, t2, 1U, t7, 1);
    xsi_vlogtype_concat(t3, 43, 43, 2U, t5, 3, t4, 40);
    t6 = (t0 + 5448);
    t8 = (t6 + 56U);
    t9 = *((char **)t8);
    t10 = (t9 + 56U);
    t11 = *((char **)t10);
    xsi_vlog_bit_copy(t11, 0, t3, 0, 43);
...
LAB14:    xsi_set_current_line(59, ng0);
    ...
    xsi_vlog_unsigned_lshift(t21, 43, t2, 32, t4, 32);
    xsi_vlog_unsigned_add(t22, 43, t3, 43, t21, 43);
    t12 = (t0 + 3048);
    xsi_vlogvar_wait_assign_value(t12, t22, 0, 0, 43, 0LL);
    ...
    t20 = *((char **)t19);
    t19 = ((char*)((ng6)));
    xsi_vlog_get_indexed_partselect(t4, 24, t5, ((int*)(t13)), 2, t20, 5, 2, t19, 32, 1, 1);
    t23 = (t0 + 3208);
    xsi_vlogvar_wait_assign_value(t23, t4, 0, 0, 24, 0LL);
    ...
    memset(t25, 0, 8);
    xsi_vlog_signed_greater(t25, 32, t5, 24, t24, 32);
    t19 = (t25 + 4);
    t7 = *((unsigned int *)t19);
    t8 = (~(t7));
    t9 = *((unsigned int *)t25);
...
LAB16:    xsi_set_current_line(74, ng0);
    ...
    memset(t25, 0, 8);
    xsi_vlog_signed_less(t25, 32, t5, 24, t4, 32);
    t13 = (t25 + 4);
    t7 = *((unsigned int *)t13);
    t8 = (~(t7));
    t9 = *((unsigned int *)t25);
...
LAB19:    xsi_set_current_line(69, ng0);
    ...
    t12 = ((char*)((ng5)));
    memset(t24, 0, 8);
    xsi_vlog_signed_minus(t24, 32, t4, 32, t12, 32);
    t13 = (t0 + 2728);
    xsi_vlogvar_wait_assign_value(t13, t24, 0, 0, 16, 0LL);
    goto LAB21;
...
LAB26:    xsi_set_current_line(78, ng0);
    ...
    t6 = ((char*)((ng7)));
    memset(t24, 0, 8);
    xsi_vlog_signed_lshift(t24, 32, t5, 32, t6, 32);
    memset(t4, 0, 8);
    xsi_vlog_signed_unary_minus(t4, 32, t24, 32);
    t12 = (t0 + 2728);
...
extern void work_m_00000000001801142162_0424797328_init()
{
	static char *pe[] = {(void *)Cont_45_0,(void *)Cont_46_1,(void *)Cont_47_2,(void *)Always_49_3};
	xsi_register_didat("work_m_00000000001801142162_0424797328", "isim/no_i2c_chip_test_isim_beh.exe.sim/work/m_00000000001801142162_0424797328.didat");
